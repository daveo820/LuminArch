...
const services = [
  ...
  { href: '/services#milestones', label: 'Milestone Celebrations' },
  { href: '/services#corporate', label: 'Corporate Events' },
  { href: '/services#custom', label: 'Custom Events' },
];
      ...
      <div className="container mx-auto section">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="relative block h-16 w-40 mb-4">
              <Image
                src={MK_LOGO}
                alt="MK Traditions"
                fill
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-champagne flex items-center justify-center transition-colors"
